test_that("cor_function works", {
  ...
  expect_equal(cor_function(x1,y1,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x1,y1,method="spearman")$parameter))
  expect_equal(cor_function(x2,y2,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x2,y2,method="spearman")$parameter))
  expect_equal(cor_function(x3,y3,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x3,y3,method="spearman")$parameter))
  expect_equal(cor_function(x4,y4,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x4,y4,method="spearman")$parameter))
  expect_equal(cor_function(x5,y5,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x5,y5,method="spearman")$parameter))
  expect_equal(cor_function(x6,y6,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x6,y6,method="spearman")$parameter))
  expect_equal(cor_function(x7,y7,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x7,y7,method="spearman")$parameter))
  expect_equal(cor_function(x8,y8,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x8,y8,method="spearman")$parameter))
  expect_equal(cor_function(x9,y9,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x9,y9,method="spearman")$parameter))
  expect_equal(cor_function(x10,y10,method="spearman",stat_test = TRUE)$df, as.numeric(cor.test(x10,y10,method="spearman")$parameter))
})
