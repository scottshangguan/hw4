test_that("cor_function works", {
  ...
  expect_equal(round(cov_function(x1,y1,method="pearson"),4), round(as.numeric(cov(x1,y1,method="pearson")),4))
  expect_equal(round(cov_function(x2,y2,method="pearson"),4), round(as.numeric(cov(x2,y2,method="pearson")),4))
  expect_equal(round(cov_function(x3,y3,method="pearson"),4), round(as.numeric(cov(x3,y3,method="pearson")),4))
  expect_equal(round(cov_function(x4,y4,method="pearson"),4), round(as.numeric(cov(x4,y4,method="pearson")),4))
  expect_equal(round(cov_function(x5,y5,method="pearson"),4), round(as.numeric(cov(x5,y5,method="pearson")),4))
  expect_equal(round(cov_function(x6,y6,method="pearson"),4), round(as.numeric(cov(x6,y6,method="pearson")),4))
  expect_equal(round(cov_function(x7,y7,method="pearson"),4), round(as.numeric(cov(x7,y7,method="pearson")),4))
  expect_equal(round(cov_function(x8,y8,method="pearson"),4), round(as.numeric(cov(x8,y8,method="pearson")),4))
  expect_equal(round(cov_function(x9,y9,method="pearson"),4), round(as.numeric(cov(x9,y9,method="pearson")),4))
  expect_equal(round(cov_function(x10,y10,method="pearson"),4), round(as.numeric(cov(x10,y10,method="pearson")),4))
  
  expect_equal(round(cov_function(x1,y1,method="spearman"),4), round(as.numeric(cov(x1,y1,method="spearman")),4))
  expect_equal(round(cov_function(x2,y2,method="spearman"),4), round(as.numeric(cov(x2,y2,method="spearman")),4))
  expect_equal(round(cov_function(x4,y4,method="spearman"),4), round(as.numeric(cov(x4,y4,method="spearman")),4))
  expect_equal(round(cov_function(x5,y5,method="spearman"),4), round(as.numeric(cov(x5,y5,method="spearman")),4))
  expect_equal(round(cov_function(x6,y6,method="spearman"),4), round(as.numeric(cov(x6,y6,method="spearman")),4))
  expect_equal(round(cov_function(x7,y7,method="spearman"),4), round(as.numeric(cov(x7,y7,method="spearman")),4))
  expect_equal(round(cov_function(x8,y8,method="spearman"),4), round(as.numeric(cov(x8,y8,method="spearman")),4))
  expect_equal(round(cov_function(x9,y9,method="spearman"),4), round(as.numeric(cov(x9,y9,method="spearman")),4))
  expect_equal(round(cov_function(x10,y10,method="spearman"),4), round(as.numeric(cov(x10,y10,method="spearman")),4))
})
